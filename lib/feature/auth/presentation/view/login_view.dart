...
import 'package:fruits_market/feature/auth/presentation/view/widgets/login_bloc_listner.dart';
import 'package:fruits_market/feature/auth/presentation/view/widgets/login_form.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                SizedBox(height: 21),
                Text("Login Up To Wikala", style: AppTextStyle.segoeUIBold),
                SizedBox(height: 28),
                LoginForm(),
                LoginBlocListener(),
              ],
